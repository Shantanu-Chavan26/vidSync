...
const MeetingTypeList = () => {
    ...
    const[meetingState, setMeetingState]=useState<'isScheduledMeeting'| 'isJoinedMeeting'| 'isInstantMeeting'| undefined>()
    ...
    const createMeeting=async()=>{
        ...
        try {
            ...
            console.log("new meet created-> ",call);
  ...
  return (
    <section className="grid grid-cols-1 gap-5 md:grid-cols-2 xl:grid-cols-4">
        ...
        <HomeCard
            ...
            handleClick={()=> setMeetingState('isJoinedMeeting')}
        ...
        <MeetingModal
            isOpen={meetingState==='isJoinedMeeting'}
            onClose={()=> setMeetingState(undefined)}
